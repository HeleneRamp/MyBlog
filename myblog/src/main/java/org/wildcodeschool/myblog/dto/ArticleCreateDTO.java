...
public class ArticleCreateDTO {
    ...
    @NotBlank(message = "Le titre ne dois pas être vide")
    @Size(min = 2, max = 50, message = "Le titre dois contenir entre 2 et 50 caractères")
    private String title;

    @NotBlank(message = "Le contenu ne doit pas être vide")
    @Size(min = 10, message = "Le contenu dois contenir au moins 10 caractères")
    ...
    @NotEmpty(message = "La liste des auteurs ne dois pas être vide")
